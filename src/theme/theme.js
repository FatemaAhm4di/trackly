...
export const createAppTheme = (mode) => createTheme({
  palette: {
    mode,
    primary: {
      main: '#0966a8', // رنگ اصلی اصلاح شده
      light: '#5aa5d9',
      dark: '#032f51',
      contrastText: '#ffffff'
    },
  ...
  typography: {
    // اضافه کردن فونت وزیرمتن برای پشتیبانی عالی از فارسی/پشتو
  ...
  shape: {
    borderRadius: 14 // گردی بیشتر و مدرن‌تر
  },
  shadows: mode === 'light' ? [
    'none',
    ...
    '0 38px 84px rgba(0,0,0,0.4)',
    '0 40px 88px rgba(0,0,0,0.42)',
    '0 42px 92px rgba(0,0,0,0.44)',
    '0 44px 96px rgba(0,0,0,0.46)',
    '0 46px 100px rgba(0,0,0,0.48)',
    ...
    '0 30px 68px rgba(0,0,0,1)',
    '0 32px 72px rgba(0,0,0,1)',
    '0 34px 76px rgba(0,0,0,1)',
    '0 36px 80px rgba(0,0,0,1)',
    '0 38px 84px rgba(0,0,0,1)',
    '0 40px 88px rgba(0,0,0,1)',
    '0 42px 92px rgba(0,0,0,1)',
    '0 44px 96px rgba(0,0,0,1)',
    '0 46px 100px rgba(0,0,0,1)',
    ...
    MuiButton: {
      styleOverrides: {
        root: {
          ...
          '&:hover': {
            boxShadow: '0 8px 20px rgba(9, 102, 168, 0.3)',
        ...
        contained: {
          ...
          '&:hover': {
            background: `linear-gradient(135deg, #032f51 0%, #0966a8 100%)`
          }
        }
      }
    },
        ...
        root: {
          '& .MuiOutlinedInput-root': {
            ...
            '&.Mui-focused fieldset': {
              borderColor: '#0966a8',
              borderWidth: '2.5px',
              boxShadow: '0 0 0 4px rgba(9, 102, 168, 0.1)'
            },
            '& input': {
              padding: '14px 16px',
              fontSize: '0.95rem'
    ...
    MuiLinearProgress: {
      styleOverrides: {
        root: {
          borderRadius: 10,
          height: 12,
          backgroundColor: mode === 'light' ? '#e5e7eb' : '#333',
          overflow: 'hidden'
        },
        bar: {
          borderRadius: 10,
          background: `linear-gradient(90deg, #0966a8, #5aa5d9)`
        }
      }
    },
    MuiIconButton: {
      styleOverrides: {
        root: {
          ...
          '&:hover': {
            backgroundColor: 'rgba(9, 102, 168, 0.08)'
          }
        }
      }
    },
